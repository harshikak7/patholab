    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-6 overflow-y-auto">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-md p-5 sm:p-6">
        ...
        <div className="grid grid-cols-2 border border-gray-300 rounded-xl overflow-hidden mb-5 text-sm sm:text-base">
          <Link
            to="/signup"
            className="py-2.5 text-center text-gray-600 hover:bg-gray-50 transition"
          >
            Sign up
          </Link>
          <Link
            to="/login"
            className="py-2.5 text-center font-semibold border-l border-gray-300 bg-white "
          >
            Log in
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-2">
          ...
          <div className="flex items-center justify-between text-xs sm:text-sm px-4 sm:px-0">
            <label className="flex items-center gap-2 text-gray-600 ">
              <input size={60} className="mt-1 w-4 h-4" type="checkbox" />
              Remember for 30 days
            </label>
            <button className="text-blue-600 font-medium hover:underline whitespace-nowrap leading-tight">
          ...
          <div className="px-4 sm:px-0">
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 rounded-xl mt-4 text-white w-full py-3"
            >
              Sign in
            </button>
          </div>
